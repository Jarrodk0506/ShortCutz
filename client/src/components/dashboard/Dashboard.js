                                    ...
                                    <List>
                                        {this.state.foundUsers.map(user => (
                                            <ListItem key={user._id}>
                                                <strong>
                                                    <img className="profileImg" src="http://tdi.auk.org/wp-content/uploads/2018/08/no-photo-man.png" alt="profile picture"></img> {user.name} {" "} <span style={{ fontFamily: "monospace" }}> is online </span>
                                                    <button className="btn waves-effect waves-light hoverable" style={{
                                                        width: "150px",
                                                        // borderRadius: "3px",
                                                        letterSpacing: "1.5px",
                                                        // marginTop: "1rem",
